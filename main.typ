...
\
Relevant Coursework: DBMS, NoSQL Databases, Operating Systems, Optimization Techniques, Applied Statistics, Mining Massive Datasets
...
- Took ownership of a *route optimization* project for a waste management company.
- Improved driver productivity and reduced daily travel distance by *8-10%*.
...
- Worked on a heuristics-based solution for a *Container Loading Problem*, improving packing efficiency by *18%*.
...
- Processed datasets using Pandas, performing data modification, deduplication, and normalization.
- Created a 5-page d/ashboard in Tableau, showcasing key metrics in 5 categories for sales data.
...
- *dAIgnostic:* _(Published in IEEE Xplore)_ Paper on effectiveness of Generative AI and RAG-based pipeline in improving healthcare.
...
- *Elev8:* DevelopedJDecentral, winning second place from 73 participants.
...
- *_CDO_ at Null Infosec Chapter:* Coordinated event management, developed CTF challenges and workshops on cybersecurity topics.
...
- *Frameworks:* React, Tailwind, Express.js, Node.js, Django, Flask, Spark, Airflow
- *Development Tools:* Git, GitHub, Docker, CLI, Chrome Dev Tools, SDLC Principles
- *Libraries:* pandas, NumPy, Matplotlib, dplyr, opencv, transformers, ortools, gurobipy
- *Databases:* MySQL, MariaDB, PostgreSQL, Redis, MongoDB, SQLite, MS SQL Server
- *Others:* AWS Cloud, Operating Systems, DBMS, Computer Networks